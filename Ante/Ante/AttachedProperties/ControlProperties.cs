...
namespace Ante.AttachedProperties
{
    public class ControlProperties
    {
        ...
        public static void HandleLetterSpaceChanged(BindableObject control, object oldValue, object newValue)
        {
            ...
            if (view.Effects?.Any(a => a is Effects.LetterSpacingEffect) == true)
            {
                view.Effects.Remove(view.Effects.Where(a => a is Effects.LetterSpacingEffect).FirstOrDefault());
            }


            view.Effects.Add(new Effects.LetterSpacingEffect { LetterSpace = (float)newValue });
        }
